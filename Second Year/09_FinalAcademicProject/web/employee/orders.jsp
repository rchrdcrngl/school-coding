...
<%
    ...
    if(request.getParameter("view")!=null&&request.getParameter("view").equals("shipped")){
        list = (new OrderDAO()).empGetShippedOrders();
    }else{
        list = (new OrderDAO()).empGetToProcessOrders();
    }
    ...
    <body>
        <header> 
            <div class="header">
                ...
                <a href="orders.jsp">View To-Process Orders</a>
                <a href="orders.jsp?view=shipped">View Shipped Orders</a>
        ...
        <div class="logo"><%=request.getParameter("view")!=null?request.getParameter("view").equals("shipped")?"Shipped Orders":"To-Process Orders":"To-Process Orders"%></div><br/><br/>
        <table class="container">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><form action="<%=request.getContextPath()%>/order" method="post"><input type="text" name="trackingNo" value="<%=o.getTrackingNo()==null?"":o.getTrackingNo()%>" required/><button type="submit" name="updateTracking" value="<%=o.getId()%>"><%=request.getParameter("view")!=null?request.getParameter("view").equals("shipped")?"Update":"Ship Order":"Ship Order"%></button></form></td>
                    <td><form action="<%=request.getContextPath()%>/order" method="post"><button type="submit" name="slip" value="<%=o.getId()%>">Generate</button></form></td>
                </tr>
                <%}%>
            </tbody>
        </table><br/><br/>
